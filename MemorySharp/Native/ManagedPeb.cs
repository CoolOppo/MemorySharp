...
namespace Binarysharp.MemoryManagement.Native
{
    ...
    public class ManagedPeb : RemotePointer
    {
        ...
        public bool BeingDebugged
        {
            get
            {
                return Read<bool>(PebStructure.BeingDebugged);
            }
            set
            {
                Write(PebStructure.BeingDebugged, value);
            }
        }
        ...
        public IntPtr FastPebLock
        {
            get
            {
                return Read<IntPtr>(PebStructure.FastPebLock);
            }
            set
            {
                Write(PebStructure.FastPebLock, value);
            }
        }
        ...
        public IntPtr FastPebLockRoutine
        {
            get
            {
                return Read<IntPtr>(PebStructure.FastPebLockRoutine);
            }
            set
            {
                Write(PebStructure.FastPebLockRoutine, value);
            }
        }
        ...
        public IntPtr FastPebUnlockRoutine
        {
            get
            {
                return Read<IntPtr>(PebStructure.FastPebUnlockRoutine);
            }
            set
            {
                Write(PebStructure.FastPebUnlockRoutine, value);
            }
        }
        ...
        public IntPtr FreeList
        {
            get
            {
                return Read<IntPtr>(PebStructure.FreeList);
            }
            set
            {
        ...
        public IntPtr GdiDcAttributeList
        {
            get
            {
                return Read<IntPtr>(PebStructure.GdiDcAttributeList);
            }
            set
            {
                Write(PebStructure.GdiDcAttributeList, value);
            }
        }
        ...
        public int ImageSubsystem
        {
            get
            {
                return Read<int>(PebStructure.ImageSubsystem);
            }
            set
            {
                Write(PebStructure.ImageSubsystem, value);
            }
        }
        ...
        public int ImageSubsystemMajorVersion
        {
            get
            {
                return Read<int>(PebStructure.ImageSubsystemMajorVersion);
            }
            set
            {
                Write(PebStructure.ImageSubsystemMajorVersion, value);
            }
        }
        ...
        public IntPtr ImageSubsystemMinorVersion
        {
            get
            {
                return Read<IntPtr>(PebStructure.ImageSubsystemMinorVersion);
            }
            set
            {
                Write(PebStructure.ImageSubsystemMinorVersion, value);
            }
        }
        ...
        public IntPtr PostProcessInitRoutine
        {
            get
            {
                return Read<IntPtr>(PebStructure.PostProcessInitRoutine);
            }
            set
            {
        ...
        public IntPtr TlsExpansionBitmap
        {
            get
            {
                return Read<IntPtr>(PebStructure.TlsExpansionBitmap);
            }
            set
            {
                Write(PebStructure.TlsExpansionBitmap, value);
            }
        }
        ...
        public IntPtr[] TlsExpansionBitmapBits
        {
            get
            {
                return Read<IntPtr>(PebStructure.TlsExpansionBitmapBits, 0x20);
            }
            set
            {
                Write(PebStructure.TlsExpansionBitmapBits, value);
            }
        }
